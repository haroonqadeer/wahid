...
export class SubsidiarieComponent implements OnInit {
    ...
    save() {
        if (this.subsidiaryTitle.trim() == '') {
            ...
            this.toastr.errorToastr('Please enter subsidiary type', 'Error', { toastTimeout: (2500) });
            return false;
        }
        ...
        // address type conditions
            ...
            this.toastr.errorToastr('Please Add Subsidiary Address Info', 'Error', { toastTimeout: (2500) });
            return false;
        }
        // contact type conditions
        else if (this.contactDetail.length == 0) {
            this.toastr.errorToastr('Please Add Subsidiary Contact Info Type', 'Error', { toastTimeout: (2500) });
            return false;
        }
        // email type conditions
        else if (this.emailDetail.length == 0) {
            this.toastr.errorToastr('Please Add Subsidiary Email Info', 'Error', { toastTimeout: (2500) });
            return false;
        }
